...
import {expenseCategoriesBreakdown, budgetVSActualSpending, ECBColors } from "@/lib/config/charts";
...
export default function FinancialPerformance() {
    ...
    const head = ["Project", "Budget", "Actual", "Variance", "Deviation", "Status"];
    ...
    const typeChecker = (row: { status: string }) => {
    ...
    return (
        <section className="space-y-5">
                ...
                <div className="w-full md:w-[65%]">
                  <CardComponent>
                    ...
                    <div className="h-[530px]">
                      <BarChartComponent data={budgetVSActualSpending} bars={bars} xKey="name" />
                    </div>
                  </CardComponent>
                </div>
            ...
            <CardComponent>
                <Heading heading="Financial Variance Analysis" subtitle="Showing % deviation from budget" />
                ...
                <div className="mt-4">
                    ...
                    renderRow={(row) => (
                        ...
                        <td className={typeChecker(row)}>{row.status === "Over Budget" || "On Track" ? "+" : "-"} {row.deviation}%</td>
