...
import ManagementStaffChartsComponent from "./charts-section";
import ManagementStaffTableComponent from "./table-section";

export default function ManagementStaffChartsAndTableParent() {
  const tabs = [
    { tabName: "Charts", id: 1 },
    { tabName: "Table", id: 2 },
  ];
    ...
    <div className="space-y-5">
      ...
      <CardComponent>
        <TabComponent
          ...
          renderContent={(tabId) => {
            if (tabId === 1) {
              return <ManagementStaffChartsComponent />;
            } else {
              return <ManagementStaffTableComponent />;
            }
          }}
        />
      </CardComponent>
