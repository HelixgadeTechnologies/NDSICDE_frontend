...
import ManagementStaffChartsAndTableParent from "@/components/management-staff-components/organizational-kpi/charts-table-parent";

export const metadata = {
  title: "Organizational KPI - NDSICDE",
  description: "View your organizational KPI",
};

export default function ManagementStaffOrganizationalKPI() {
  const dashboardData = [
    {
  ...
  return (
    <section>
      ...
      <ManagementStaffChartsAndTableParent />
    </section>
  );
}
