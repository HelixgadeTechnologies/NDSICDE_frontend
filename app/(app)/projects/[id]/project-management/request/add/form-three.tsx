...
export default function FormThree({
  ...
  const handleRemovePersonnel = (index: number) => {
    const newList = (formData.otherPersonnel || []).filter(
      (_, i) => i !== index,
    );
  ...
  const handleNext = () => {
    // If journey management is not required, bypass all validations
    if (!formData.isJourneyRequired) {
      onNext();
      return;
    }
  ...
  return (
    <section>
      <form className="space-y-6" onSubmit={handleFormSubmit}>
        {/* Header with checkbox at top-right */}
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 border-b border-gray-100 pb-4 mb-4">
          <Heading heading="Journey Management" className="text-left" />
          <div className="flex items-center">
            <Checkbox
              label="Not Required"
              name="isJourneyRequired"
              isChecked={!formData.isJourneyRequired}
              onChange={(checked) =>
                updateFormData({ isJourneyRequired: !checked })
              }
            />
          </div>
        </div>

        {/* Readonly Info Bar for Staff and Request Date */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg bg-gray-50 border border-gray-200 shadow-sm mb-6">
          <div className="space-y-1">
            <span className="text-xs font-semibold text-gray-505 uppercase tracking-wider block">
              Staff Name
            </span>
            <div className="px-4 py-2.5 bg-white border border-gray-200 rounded-md text-sm font-semibold text-gray-800 shadow-sm">
              {formData.staff || "N/A"}
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="px-4 py-2.5 bg-white border border-gray-200 rounded-md text-sm font-semibold text-gray-800 shadow-sm">
              {formData.requestDate || new Date().toLocaleDateString()}
            </div>
          </div>
        </div>

        {/* Conditionally render form fields or friendly bypass message */}
        {!formData.isJourneyRequired ? (
          <div className="text-center p-10 border border-dashed border-gray-300 rounded-xl bg-gray-50/50 space-y-3 my-6">
            <div className="mx-auto w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
              <Icon icon="mdi:car-off" className="text-2xl text-gray-400" />
            </div>
            <h3 className="text-base font-bold text-gray-800">
              Journey Management is Omitted
            </h3>
            <p className="text-sm text-gray-500 max-w-md mx-auto">
              This request does not require any journey management details. You
              can click &quot;Next&quot; below to proceed directly to review and
              submit your request.
            </p>
          </div>
        ) : (
          <>
            ...
            <TextareaInput
              ...
              onChange={(e) =>
                updateFormData({ purposeOfTrip: e.target.value })
              }
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-6">
                ...
                <RadioInput
                  ...
                  name="modeOfTransport"
                  onChange={(e) =>
                    updateFormData({ modeOfTransport: "Flight" })
                  }
              ...
              <>
                ...
                <div className="space-y-4 pt-2">
                  <Heading
                    ...
                    sm
                    className="border-b border-gray-100 pb-2 text-[#D2091E]"
                  />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <TextInput
                      ...
                      onChange={(e) =>
                        updateFormData({ driverName: e.target.value })
                      }
                    ...
                    <TextInput
                      ...
                      onChange={(e) =>
                        updateFormData({ driversPhoneNumber: e.target.value })
                      }
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <TextInput
                      ...
                      onChange={(e) =>
                        updateFormData({ vehiclePlateNumber: e.target.value })
                      }
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <TextInput
                    ...
                    onChange={(e) =>
                      updateFormData({ flightDepartureState: e.target.value })
                    }
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      updateFormData({ flightDepartureTime: e.target.value })
                    }
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      updateFormData({ flightArrivalState: e.target.value })
                    }
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      updateFormData({ flightArrivalTime: e.target.value })
                    }
                  ...
                  <div className="md:col-span-2">
                    <TextInput
                      ...
                      onChange={(e) =>
                        updateFormData({
                          hotelAccommodationName: e.target.value,
                        })
                      }
                  ...
                  <div className="md:col-span-2">
                    <TextareaInput
                      ...
                      onChange={(e) =>
                        updateFormData({ hotelAddress: e.target.value })
                      }
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      updateFormData({ returnTime: e.target.value })
                    }
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      updateFormData({
                        airportDropoffOfficerName: e.target.value,
                      })
                    }
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      updateFormData({
                        airportPickupOfficerName: e.target.value,
                      })
                    }
            ...
            <div className="space-y-4 pt-2">
              <Heading
                heading="Other Personnel Travelling (Optional)"
                sm
                className="border-b border-gray-100 pb-2 text-[#D2091E]"
              />
              ...
              {(formData.otherPersonnel || []).map((person, index) => (
                <div
                  key={index}
                  className="p-4 border border-gray-200 rounded-lg bg-gray-50 relative space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <TextInput
                      ...
                      onChange={(e) =>
                        handlePersonnelChange(index, "company", e.target.value)
                      }
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    updateFormData({ departureLocationAndTime: e.target.value })
                  }
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    updateFormData({
                      contactPersonPhoneNumberAtDestination: e.target.value,
                    })
                  }
