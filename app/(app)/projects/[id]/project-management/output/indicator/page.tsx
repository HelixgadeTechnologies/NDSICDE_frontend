                  ...
                  <AnimatePresence>
                    ...
                    >
                      <ul className="text-sm">
                        ...
                        <Link href={"/project-management/output/indicator/actual-value/report"} className="cursor-pointer hover:text-blue-600 border-b border-gray-300 flex gap-2 p-3 items-center">
