...
import ViewIndicators from "@/components/team-member-components/view-indicators";
...
export default function IndicatorPage() {
  ...
  return (
    <div className={`pt-8 px-6 pb-6 rounded-[10px] bg-white ${isViewMode ? "w-full" : "w-156 border border-[#E4E7EC] "}`}>
      <Heading heading={headingText} className="text-center" />
      {isViewMode ? (
        <ViewIndicators resultId={resultId} />
      ) : (
